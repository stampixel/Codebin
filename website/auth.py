...
def register():
    if request.method == 'POST':
        ...
        if user:
            ...
            new_user = User(username=username, password=generate_password_hash(password1, method='sha256')) # adds user to DB
            ...
            defualt_profile = Profile(pfp='https://i.imgur.com/eNsgEu8.png', about_me="Your 'About Me' page, write something about yourself!", user_id=current_user.id) # sets up their default profile
